 ...
 * ensuring that all operations (even most passed in {@link java.awt.image.BufferedImageOp}s)
...
class Scalr
{
	...
	public static enum PaddingBorder {
		LEFT_RIGHT,
		TOP_BOTTOM,
		ALL,
	}
	...
	public static BufferedImage pad(BufferedImage src, int padding,
		...
		return pad(src, padding, padding, color, ops);
	}
	 ...
	 *             operations.
	 */
	public static BufferedImage pad(BufferedImage src, int padding_x, int padding_y,
		 ...
		 * image.
		 */
		int newWidth = srcWidth + padding_x * 2;
		int newHeight = srcHeight + padding_y * 2;

		if (DEBUG)
			log(0,
					"Padding Image from [originalWidth=%d, originalHeight=%d, padding=%d] to [newWidth=%d, newHeight=%d]...",
					srcWidth, srcHeight, padding_x, newWidth, newHeight);
		...
		g.drawImage(src, padding_x, padding_y, null);
		g.dispose();
