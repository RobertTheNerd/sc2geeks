...
include_once( dirname( __FILE__ ) . '/lib/class-wp-json-sc2objects.php' );
...
function json_api_default_filters( $server ) {
	global $wp_json_posts, $wp_json_pages, $wp_json_media, $wp_json_taxonomies, $wp_json_sc2objects;
	...
	// SC2 Objects
	$wp_json_sc2objects = new WP_JSON_SC2Objects( $server );
	add_filter( 'json_endpoints',      array( $wp_json_sc2objects, 'register_routes'       ), 0 );
